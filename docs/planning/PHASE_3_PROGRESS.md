...
Status: implementation ready; Admin setup email delivered, acceptance and live staff rehearsal pending.
...
- The server-only Supabase key works with the Auth Admin API; Resend reports the official Admin setup email as delivered.

## Still required before Phase 3 exit

1. Accept the delivered official Admin setup link, set a password, and verify `/admin` and `/admin/operators`.
