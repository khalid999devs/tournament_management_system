...
20 September 2026. The platform is deployed at
**https://ndcak-indoor-games.vercel.app** and was rehearsed there before
launch. This records what was checked, what the rehearsal measured, and the
two problems it found.

## What was required

| Requirement                                                                             | Evidence                                                                                                                                                                                                                                                                                                                                                                   |
| --------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Critical flows pass unit, integration and end-to-end suites.                            | 116 unit tests, 59 integration tests against PostgreSQL, and a 39-test Playwright suite (`docs/qa/END_TO_END_TESTS.md`) covering registration, admin review, operator invitations and scopes, two operators on one match, accessibility, keyboard use, screen widths and security headers.                                                                                 |
